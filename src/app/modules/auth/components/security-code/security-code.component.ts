...
export class SecurityCodeComponent implements AfterViewInit {
  ...
  constructor(public loadingController: LoadingController, private _authService: AuthService) { }
  ...
  goToNextInput(securityCodeInputs: any) {

    securityCodeInputs.forEach((ele: any, index: any) => {
  ...
  setCredentialString(credentialString: string) {
    localStorage.setItem("userId", credentialString);
  }
